...
class Relevance(Scanner):
    ...
    def __init__(
        self,  model: Tuple = MODEL_EN_BGE_BASE, use_onnx: bool = False
    ):
        """
    ...
    def scan(self, prompt: str, output: str, **kwargs: Optional[Dict[str, Any]]) -> (str, bool, float):
        ...
        kwargs_1 = kwargs.get("Relevance",default_kwargs)
        threshold = kwargs_1.get("threshold",0.5)
        ...
        return output, True, round(1 - similarity, 2)
